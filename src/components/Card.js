...
export default class Card extends Component {
  render() {
    const { label, value, hasLogo, isViews, isPercentage } = this.props;
    return (
        ...
        <Container className='card grid-card is-card-dark'>
          <Container className='card-heading'>
            ...
            {hasLogo && (
              <Container className='card-heading-brand'>
                {this.props.isOkazii && (
                  <img
                    src={'https://static.okr.ro/images/www/okazii-logo.png'}
                  />
                )}
                {this.props.isPubli && <img src={publi24Logo} />}
                {this.props.isOlx && <img src={olxLogo} />}
                {this.props.isLajum && (
                  <img src={'https://media1.lajumate.ro/images/logo-ljm.png'} />
                )}
              </Container>
            )}
          </Container>
          ...
          <Container className='card-value pt-4 text-x-large'>
            {!isPercentage ? (
              ...
              <span>{value}% din venitul total</span>
            )}
          </Container>
        </Container>
      </Container>
